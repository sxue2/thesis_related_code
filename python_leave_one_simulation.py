...
from readAsremlLeaveOne import extractVC
import sys
...
def fullScan(model,trait,chr,DAratio,unitTime,rep):
    ...
    VCdir = '/home/sxue2/thirdProject/Data_prep/leave_oneGmatrix_all_families.giv/asremlCode_estimate_VC/code_for_asreml/'
...
#         p.start()    
#         p.join()
    fullScan("model5",sys.argv[1],1,sys.argv[2],sys.argv[3],sys.argv[4])